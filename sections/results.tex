...
\section*{Results}
  ...
  Furthermore, the most abundant Genus (among the top 50 representative sequences) in the \ac{ncbi} taxonomy table was \textit{Escherichia} whereas it was assigned to "unknown" in \ac{gg} and in the SILVA taxonomy table it was assigned to \textit{Escherichia-Shigella}.
 ...
 % There are also other studies, [ref, OTT paper] that focus on the database aspect and they too have found that...
  ...
  For the chimera checking module of the \ac{dc} step, both uchime-denovo and remove bimera perform similarly, we suggest using remove bimera since it was developed specifically for \ac{dada2} and should provide the best performance for that denoising method.
