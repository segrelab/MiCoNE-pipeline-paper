...
\section*{Results}
  ...
  % TODO: Update this
  Figure~\ref{fig:figureS4} shows that the top 20 most abundant genera in the three resulting taxonomy composition tables are different.
  ...
  Although these are minor differences, when comparing a large number of composition tables these problems are hard to diagnose.
