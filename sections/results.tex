...
\section*{Results}
  ...
  % How are the top assignments when compared
  % How does these assignments vary across level
  % What does this mean for us, conclusions
  % What does the mock data show?
  % Is there a best tool/database? What would you choose as the default?
