...
\section*{Results}
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
      ...
      \hline
    \end{tabular}
    \caption{Default tools and parameters for the pipeline. Detailed information can be found in the methods section}
  ...
  Therefore, we propose the construction of a \hl{consensus network} (Figure~\ref{fig:figure5}C) involving \ac{magma}, \ac{mldm}, \ac{spieceasi} and \ac{sparcc} by merging the p-values generated from bootstraps of the original taxonomy composition table using the Browns pvalue combining method (ref).
