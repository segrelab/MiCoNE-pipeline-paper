...
\section*{Results}
  ...
  % FIXME: Supplementary work - Figure S3
  ...
  The Deblur method returns a very small number of reference sequences (2388) and this could account for the reason for the high dissimilarity with the other methods as well as irregular performance on the mock data.
