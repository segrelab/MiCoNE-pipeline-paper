...
\section*{Results}
  ...
  \todo[size=\footnotesize]{Wait for results from network inference methods}
  ...
  In order to verify this claim, we changed the threshold for the sequence count and recalculated the weighted and unweighted UniFrac distance metrics and also looked at the number of representative sequences identified in each case. \todo[size=\footnotesize]{Haven't done this. This should be in supplementary}
  ...
  Again, we observe that none of the databases perform better than the others. \todo[size=\footnotesize]{Has to be verified}
