...
% Tables
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|}
      ...
      \hline
      \multirow{7}{*}{Denoising and Clustering} & \multirow{5}{*}{Denoising and Clustering} & Closed reference & \cite{rognesVSEARCHVersatileOpen2016,bolyenReproducibleInteractiveScalable2019} \\
