...
\section*{Materials and Methods}
  ...
  \subsection*{Datasets}
    ...
    The real datasets were control samples (49samples) \todo[size=\footnotesize]{Check the exact number} obtained from \cite{Kang2017}.
  ...
  \subsection*{16S processing pipeline}
    ...
    % TODO: Talk about what is happening in the pipeline NOT what that steps does in theory
