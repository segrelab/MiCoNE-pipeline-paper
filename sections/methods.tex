...
\section*{Materials and Methods}
 ...
 \subsubsection*{Notation}
  ...
  w = the number of co-occurrence networks generated from different approaches

  $N^i$ = The weights of the $i^{th}$ co-occurrence network represented as a $q \times q$ adjacency matrix, where $i \in {1, q}$
