...
\section*{Materials and Methods}
  ...
  The scripts used to generate the synthetic data are in the scripts folder of the respository (\href{https://github.com/segrelab/mind-pipeline-paper}{https://github.com/segrelab/mind-pipeline-paper}).
