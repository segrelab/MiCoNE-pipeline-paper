...
\begin{abstract}
  {
    ...
    We envisage that this pipeline could be used for integrating multiple datasets, and for generating comparative analyses and consensus networks that can help understand microbial community assembly in different biomes.
  }
\end{abstract}
