...
\section*{Supplementary}
  ...
  \subsection*{Effects of low abundant reference sequences in the \ac{dc} step}
    ...
    In Figure~\ref{fig:figureS3} however, we use only the top  100 reference sequences (by abundance) for this calculation.
    We observe that both the weighted and unweighted UniFrac distances are reduced compared to the figure with the all the reference sequences.
    This shows that the most abundant reference sequences generated by the methods are similar to each other.
    ...
    \begin{figure}[H]
      \centering
        \caption{
          \textbf{The UniFrac distance between the 100 most abundant reference sequences generated by various method in the \ac{dc} step}
        }
      \label{fig:figure_s3}
    \end{figure}
    \FloatBarrier
