...
output_file <- paste0(output_folder, "figure3.pdf")
output_file_a <- paste0(output_folder, "figure3a.pdf")
output_file_b <- paste0(output_folder, "figure3b.pdf")
output_file_c <- paste0(output_folder, "figure3c.pdf")
