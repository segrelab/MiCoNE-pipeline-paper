...
combined_plot_b <- ggarrange(gg_silva_plot, gg_ncbi_plot, ncbi_silva_plot, nrow=1, ncol=3, common.legend=TRUE, legend="right")
...
ggsave("figure4.pdf", width=11, height=16)