...
if (length(args) == 0) {
    data_folder <- "../../data/figure_s8/output/norta/"
...
output_file <- paste0(output_folder, "figure_s8.pdf")
...
final_plot <- ggarrange(facet_indv, facet_sv, facet_ss, ncol = 1, common.legend = TRUE, legend = "right", heights = c(3, 2, 2))
