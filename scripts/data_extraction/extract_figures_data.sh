...
python extract_figure4_data.py $INPUT_FOLDER $DATASET "fmt-control"
python extract_figure6_data.py $INPUT_FOLDER $DATASET "fmt-control"
python extract_figure7_data.py $INPUT_FOLDER $DATASET "fmt-control" "fmt-autism"
