...
unweighted <- read.csv("hp_unweighted_unifrac.csv", sep=",", header=TRUE)
unweighted_tidy <- tidy_up_data(unweighted)
weighted <- read.csv("hp_weighted_unifrac.csv", sep=",", header=TRUE)
...
ggsave("figure_s2.pdf", heatmap_plot, width=11, height=8.5)
